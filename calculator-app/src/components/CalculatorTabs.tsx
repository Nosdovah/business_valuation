    ...
    <div key={name} className="flex flex-col gap-1 mb-4">
      ...
      <div className="relative flex items-center">
        <input
          ...
          className={`glass-input w-full ${unit ? 'pr-12' : ''}`}
        />
        {unit && (
    ...
    <div className="glass-card flex flex-col h-full sticky top-6 overflow-hidden">
      ...
      <div className="p-6 flex-grow flex flex-col">
        <div className="flex-grow space-y-2">
           {fields.includes('fv') && renderInput('fv', 'Future Value (FV)', '135500', 'USD')}
           {fields.includes('pv') && renderInput('pv', 'Present Value (PV)', '100000', 'USD')}
           {fields.includes('pmt') && renderInput('pmt', 'Payment (PMT)', '10000', 'USD')}
           {fields.includes('i') && renderInput('i', 'Interest Rate (i % per period)', '6', '%')}
           {fields.includes('n') && renderInput('n', 'Number of Periods (n)', '14', 'N')}
        </div>
