  ...
  return (
    <div className="glass-card flex flex-col h-full sticky top-6 overflow-hidden transition-all duration-300">
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        {error && (
          <div className="mt-4 p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium animate-pulse flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400"></span>
            Please fill in all required parameters
          </div>
        )}
 
        <button onClick={handleCalculate} className="btn-primary w-full mt-6 flex items-center justify-center gap-2 py-3 text-lg font-bold group">
